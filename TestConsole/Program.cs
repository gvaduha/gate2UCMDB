...
namespace ucmdb
{
  class Program
  {
    ...
    static void Main(string[] args)
    {
      try
      {
        string serviceUri = "http://localhost:80/WebServices.t7_rb/EmployeeService.svc";
        string ucmdbUri = "http://localhost:8080/axis2/services/UcmdbService";
        string login = "guest";
        string password = "guest123";
        string lastDate = "2011/11/11";
        int chunkSize = 16;
        ...
        //////                      //,EndpointIdentity.CreateSpnIdentity("HOST/ucmdb:8008")
                              ));
